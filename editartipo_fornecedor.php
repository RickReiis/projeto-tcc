...
$id = $_GET['id'];
$pesquisa2 = mysql_query("SELECT * FROM tipo_fornecedor WHERE idtipo_fornecedor='$id'");
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>Editar</b></span>
        </a>
        ...
        <div class="row" id="resultado">
          <div class="col-xs-12">
            <div class="box box-primary">
              ...
              <form action="enviar.php?acao=editar_tipofornecedor&id=<?php echo "$id"; ?>" method="post">          
               <div class="form-group">
               <label>Tipo fornecedor:</label>
               <input required="" class="form-control" type="text" name="tipo_fornecedor" value="<?php echo "$tipo"; ?>">
               </div> 
