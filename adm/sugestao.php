...
<head>
  ...
  <title>Sugestão | Administrador </title>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <table class="table table-striped">
            ...
            <?php
                include"config.php";
                $sql = mysql_query("SELECT * FROM sugestao");
            ...
            ?>
                    <tr>
                      ...
                      <td>
                          <a href="controle.php?excluirsug&id=<?php echo $row->idsugestao; ?>"><span class="glyphicon glyphicon-remove" style="color:red;"></a></span>
                      </td>
                    </tr> 
            <?php
                  }
