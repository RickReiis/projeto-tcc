            ...
            ?>
                    <tr>
                      ...
                      <td>
                         ...
                         <a href="controle.php?excluiradm&id=<?php echo $row->idadministrador; ?>"><span class="glyphicon glyphicon-remove" style="color:red;"></a></span>
                         <a href="editaradm.php?id=<?php echo $row->idadministrador;?>"><span class="glyphicon glyphicon-pencil" style="color:black;"></a></span>
                      </td>
                    </tr> 
            <?php
                  }
