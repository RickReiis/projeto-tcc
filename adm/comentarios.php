...
<head>
  ...
  <title>Comentários | Administrador </title>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <table class="table table-striped">
            ...
            <?php
                include"config.php";
                $sql = mysql_query("SELECT comentario.idcomentario, comentario.usuario, comentario.turma, comentario.comentario, saberes.nome FROM comentario, saberes WHERE comentario.saberes_idsaberes = saberes.idsaberes");
            ...
            ?>
                    <tr>
                      ...
                      <td>
                         <a href="controle.php?excluircom&id=<?php echo $row->idcomentario; ?>"><span class="glyphicon glyphicon-remove" style="color:red;"></a></span>
                      </td>
                    </tr> 
            <?php
                  }
