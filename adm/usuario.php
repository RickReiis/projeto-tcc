...
<head>
  ...
  <title> Validar Usuarios | Administrador </title>
      ...
      <div class="box">
        <div class="box-body">
          <table class="table table-striped">
            ...
            <?php
                include"config.php";
                $sql = mysql_query("SELECT usuario.idusuario, usuario.usuario, usuario.turma, usuario.email, usuario.telefone, usuario.foto, usuario.materia,saberes.nome, usuario.status FROM usuario, saberes WHERE usuario.saberes_idsaberes = saberes.idsaberes  and status = 0 order by idusuario asc");
            ...
            ?>
                    <tr>
                      ...
                      <td>
                          <a href="controle.php?validarform&status=<?php echo $row->idusuario; ?>"><span class="glyphicon glyphicon-ok" style="color:green;"> 
                          </span></a>
                      </td>
                    </tr> 
            <?php
